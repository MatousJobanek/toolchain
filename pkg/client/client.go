...
func (p ApplyClient) applyObject(obj client.Object, options ...ApplyObjectOption) (bool, error) {
	...
	if err := p.cl.Get(context.TODO(), namespacedName, existing); err != nil {
		if apierrors.IsNotFound(err) {
			return true, p.createObj(obj, obj, config.owner)
		}
...
func RetainClusterIP(newResource, existing client.Object) error {
...
func clusterIP(obj client.Object) (string, bool, error) {
	switch obj := obj.(type) {
	case *corev1.Service:
...
func marshalObjectContent(newResource client.Object) ([]byte, error) {
